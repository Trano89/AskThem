...
{
    /// <summary>
    /// Produit le PDF d'un contrôle de fabrication.
    ///
    ...
    {
        /// <summary>
        /// Écrit le contrôle dans le dossier indiqué et retourne le chemin du fichier créé.
        ...
        /// </summary>
        string Generer(ControleFabrication controle, string dossier);
    }
}
